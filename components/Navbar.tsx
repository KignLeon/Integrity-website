      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <div className="flex items-center gap-2 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          ...
          <span className={`text-2xl font-black tracking-tighter transition-colors duration-500 ${isScrolled ? 'text-slate-900' : 'text-white'}`}>
            {CONTACT_INFO.logoText}<span className="text-amber-500 font-normal ml-0.5">ELECTRICAL</span>
          </span>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-10">
          ...
          <a href="#why-integrity" className={`text-[11px] font-black uppercase tracking-[0.2em] transition-all hover:text-amber-500 ${isScrolled ? 'text-slate-500' : 'text-slate-300'}`}>Why Us</a>
          <a href="#tesla" className={`text-[11px] font-black uppercase tracking-[0.2em] transition-all hover:text-amber-500 ${isScrolled ? 'text-slate-500' : 'text-slate-300'}`}>Battery</a>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <button 
            ...
            className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-3.5 rounded-2xl font-black text-sm shadow-lg transition-all transform hover:-translate-y-0.5 active:scale-95 whitespace-nowrap"
          >
            FREE ESTIMATE
          </button>
        </div>
